...
#define NODE_MAIN_LOGGER_NAME "dr16_dbus_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libdr16_dbus.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<dr16_dbus::Dr16Dbus>";
