...
static const _TwistStampedToWheel_type_support_symbol_names_t _TwistStampedToWheel_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, sensebeetle_interfaces, msg, TwistStampedToWheel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, sensebeetle_interfaces, msg, TwistStampedToWheel)),
  }
};
...
{
  return &::sensebeetle_interfaces::msg::rosidl_typesupport_cpp::TwistStampedToWheel_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, sensebeetle_interfaces, msg, TwistStampedToWheel)() {
  return get_message_type_support_handle<sensebeetle_interfaces::msg::TwistStampedToWheel>();
}
